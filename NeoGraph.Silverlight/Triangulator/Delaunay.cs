...
namespace ceometric.DelaunayTriangulator
{
    ...
    public class DelaunayTriangulation2d
    {
        ...
        public List<Triangle> Triangulate(List<Vertex> triangulationPoints)
        {
            ...
            for (int i = 0; i < triangulationPoints.Count; i++)
            {
                ...
                {
                    triangles.Add(new Triangle(EdgeBuffer[j].VertexFirst, EdgeBuffer[j].VertexSecond, triangulationPoints[i]));
                }
            }
